...
const Index = () => {
    ...
    return (
        <div>
            ...
            <p className='mt-12 mb-2 font-bold text-center'><em><strong className='text-center'>Nubia Studio Hair</strong></em><br /> Estamos abertos a ouvir sua opinião e sugestão.</p>
